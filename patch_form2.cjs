...
const lunchSection = `
        ...
        {/* Lunch Break Section */}
        <section className={cn("bg-white p-4 rounded-xl border border-gray-200 shadow-sm space-y-4 transition-opacity", (workType !== 'Workshop' && !jobStart) ? "opacity-50 pointer-events-none" : "opacity-100")}>
...
c = c.replace(/\{\/\* Job Section \*\/\}/, lunchSection + '\n\n        {/* Job Section */}');
